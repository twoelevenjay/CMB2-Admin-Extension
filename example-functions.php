...
function yourprefix_register_repeatable_group_field_metabox() {
	...
	'name'             =>  __( 'Field Type', 'cmb2' ),
	'desc'             =>  __( 'Pick what type of field to display. For a full list of fields visit <a href="https://github.com/WebDevStudios/CMB2/wiki/Field-Types">the documentation</a>.', 'cmb2' ),
