...
== Description ==
CMB2 Admin Extension adds an intuitive user interface for WordPress administrators to create, manage, and display CMB2 meta boxes directly from the WordPress admin dashboard. This plugin simplifies the process of building custom meta boxes, making it easier for non-technical users to add custom fields to posts, pages, and other content types.
